...
export class Migration20241209152228 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table if not exists "media" ("id" text not null, "fileid" text not null, "name" text not null, "mimeType" text not null, "isThumbnail" boolean not null, "url" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "media_pkey" primary key ("id"));');
